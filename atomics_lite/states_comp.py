...
from atomics_lite.pde_problem import PDEProblem

# from atomics_lite.pdes.elastic_cantilever_beam import get_residual_form
# from atomics_lite.pdes.hyperelastic_neo_hookean_addtive_test import get_residual_form
...
class StatesComp(om.ImplicitComponent):
    ...
    def solve_nonlinear(self, inputs, outputs, tol):
        ...
        if problem_type == 'linear_problem':
            ...
            solver.parameters["snes_solver"]["absolute_tolerance"]=tol
